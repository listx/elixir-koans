defmodule Numbers do
  ...
  koan "Another way to divide" do
    # Like "/", but discards the remainder.
    assert div(5, 2) == 2
  end

  koan "What remains or: The Case of the Missing Modulo Operator (%)" do
    # Like the modulo operator (%) in other languages.
    assert rem(5, 2) == 1
  end
  ...
  koan "Two ways to round, are they exactly the same?" do
    # Float.round() keeps it a float.
    # round() converts the float to an integer.
  ...
  koan "The meaning of life in hexadecimal is 2A!" do
    # The unparseable part is returned at the end. Since 2A parses to 42, there
    # is no unparseable part ("").
    # See https://hexdocs.pm/elixir/1.12.1/Integer.html#parse/2.
