defmodule PatternMatching do
  ...
  koan "A variable can be pinned to use its value when matching instead of binding to a new value" do
    ...
    example = fn
      # If we don't pin it, then `pinned_variable` here always succeeds as a
      # pattern match, so we always return "The number One".
    ...
    assert example.(20) == "The number 20"
    assert pinned_variable == 1
  end
