defmodule Functions do
  ...
  # But this guard "a <= b" is redundant because if the above condition does not
  # hold (a > b), then by definition we're already in a case where a <= b here.
  ...
  koan "The result of a function can be piped into another function as its first argument" do
    result =
      "full-name"
      # This call is equivalent to String.split("full-name", "-")
      |> String.split("-")
